...
[![Image](https://thedevopsstore.com/course-images/AWS-EKS-Kubernetes-Masterclass-DevOps-Microservices-course.png "AWS EKS Kubernetes - Masterclass")](https://www.udemy.com/course/aws-eks-kubernetes-masterclass-devops-microservices/?referralCode=257C9AD5B5AF8D12D1E1)
...
| ----------------- | ----------------- |
| Simple Nginx V1  | thedevopsstore/kubenginx:1.0.0  |
| Spring Boot Hello World API  | thedevopsstore/kube-helloworld:1.0.0  |
| Simple Nginx V2  | thedevopsstore/kubenginx:2.0.0  |
| Simple Nginx V3  | thedevopsstore/kubenginx:3.0.0  |
| Simple Nginx V4  | thedevopsstore/kubenginx:4.0.0  |
| Backend Application  | thedevopsstore/kube-helloworld:1.0.0  |
| Frontend Application  | thedevopsstore/kube-frontend-nginx:1.0.0  |
...
- [Udemy Enroll](https://github.com/thedevopsstore/udemy-enroll)

## The DevopsStore Udemy Profile
